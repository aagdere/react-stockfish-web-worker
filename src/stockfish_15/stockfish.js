...
var fa=[];c.addMessageListener=function(a){fa.push(a)};c.removeMessageListener=function(a){a=fa.indexOf(a);0<=a&&fa.splice(a,1)};c.print=c.printErr=function(a){if(0===fa.length)return console.log(a);for(var b of fa)b(a)};c.terminate=function(){m.pa()};
...
function ra(a){this.name="ExitStatus";this.message="Program terminated with exit("+a+")";this.status=a}function Qa(a){(a=m.ea[a])||C();m.na(a)}function Ra(a){var b=m.wa();if(!b)return 6;m.ia.push(b);m.ea[a.N]=b;b.N=a.N;var d={cmd:"run",start_routine:a.Ca,arg:a.ta,pthread_ptr:a.N};t&&b.ref();b.postMessage(d,a.Ha);return 0}function Sa(a){if(z)return U(1,1,a);if(!noExitRuntime){m.pa();if(c.onExit)c.onExit(a);E=!0}la(a,new ra(a))}function Ta(a,b){if(!b&&z)throw Ua(a),"unwind";Sa(a)}
function Va(a){a instanceof ra||"unwind"==a||la(1,a)}
var m={ha:[],ia:[],ra:[],ea:{},xa:function(){z&&m.ya()},Ka:function(){},ya:function(){m.receiveObjectTransfer=m.Ba;m.threadInitTLS=m.qa;m.setExitStatus=m.oa;noExitRuntime=!1},oa:function(){},pa:function(){for(var a of Object.values(m.ea))m.na(a);for(a of m.ha)a.terminate();m.ha=[]},na:function(a){var b=a.N;delete m.ea[b];m.ha.push(a);m.ia.splice(m.ia.indexOf(a),1);a.N=0;t&&a.unref();Wa(b)},Ba:function(){},qa:function(){m.ra.forEach(a=>a())},Aa:a=>new Promise(b=>{a.onmessage=g=>{g=g.data;var h=g.cmd;
a.N&&(m.ua=a.N);if(g.targetThread&&g.targetThread!=Xa()){var q=m.ea[g.La];q?q.postMessage(g,g.transferList):B('Internal error! Worker sent a message "'+h+'" to target pthread '+g.targetThread+", but that thread no longer exists!")}else if("processProxyingQueue"===h)Ya(g.queue);else if("spawnThread"===h)Ra(g);else if("cleanupThread"===h)Qa(g.thread);else if("killThread"===h)g=g.thread,h=m.ea[g],delete m.ea[g],h.terminate(),Wa(g),m.ia.splice(m.ia.indexOf(h),1),h.N=0;else if("cancelThread"===h)m.ea[g.thread].postMessage({cmd:"cancel"});
else if("loaded"===h)a.loaded=!0,t&&!a.N&&a.unref(),b(a);else if("print"===h)ua("Thread "+g.threadId+": "+g.text);else if("printErr"===h)B("Thread "+g.threadId+": "+g.text);else if("alert"===h)alert("Thread "+g.threadId+": "+g.text);else if("setimmediate"===g.target)a.postMessage(g);else if("callHandler"===h)c[g.handler](...g.args);else h&&B("worker sent an unknown command "+h);m.ua=void 0};a.onerror=g=>{B("worker sent an error! "+g.filename+":"+g.lineno+": "+g.message);throw g;};t&&(a.on("message",
function(g){a.onmessage({data:g})}),a.on("error",function(g){a.onerror(g)}),a.on("detachedExit",function(){}));var d=[],f=["onExit","onAbort","print","printErr"],k;for(k of f)c.hasOwnProperty(k)&&d.push(k);a.postMessage({cmd:"load",handlers:d,urlOrBlob:c.mainScriptUrlOrBlob||_scriptDir,wasmMemory:D,wasmModule:wa})}),za:function(a){a()},sa:function(){var a=na("stockfish.worker.js");a=new Worker(a);m.ha.push(a)},wa:function(){0==m.ha.length&&(m.sa(),m.Aa(m.ha[0]));return m.ha.pop()}};c.PThread=m;
function Za(a){for(;0<a.length;)a.shift()(c)}c.establishStackSpace=function(){var a=Xa(),b=P[a+52>>2];$a(b,b-P[a+56>>2]);ab(b)};function Ua(a){if(z)return U(2,0,a);try{Ta(a)}catch(b){Va(b)}}c.invokeEntryPoint=function(a,b){a=bb.apply(null,[a,b]);noExitRuntime?m.oa(a):cb(a)};function db(a,b,d,f){return z?U(3,1,a,b,d,f):eb(a,b,d,f)}
function eb(a,b,d,f){if("undefined"==typeof SharedArrayBuffer)return B("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var k=[];if(z&&0===k.length)return db(a,b,d,f);a={Ca:d,N:a,ta:f,Ha:k};return z?(a.Ja="spawnThread",postMessage(a,k),0):Ra(a)}function fb(a,b,d){return z?U(4,1,a,b,d):0}function gb(a,b,d){return z?U(5,1,a,b,d):0}function hb(a,b,d,f){if(z)return U(6,1,a,b,d,f)}
...
0,4));u=q(u);return 0>=h(r,e)?0>=h(u,e)?e.getFullYear()+1:e.getFullYear():e.getFullYear()-1}var x=P[f+40>>2];f={Fa:P[f>>2],Ea:P[f+4>>2],ja:P[f+8>>2],ma:P[f+12>>2],ka:P[f+16>>2],ga:P[f+20>>2],da:P[f+24>>2],fa:P[f+28>>2],Ma:P[f+32>>2],Da:P[f+36>>2],Ga:x?F(x):""};d=F(d);x={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d",
"%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var y in x)d=d.replace(new RegExp(y,"g"),x[y]);var Y="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),M="January February March April May June July August September October November December".split(" ");x={"%a":function(e){return Y[e.da].substring(0,3)},"%A":function(e){return Y[e.da]},"%b":function(e){return M[e.ka].substring(0,3)},"%B":function(e){return M[e.ka]},
"%C":function(e){return g((e.ga+1900)/100|0,2)},"%d":function(e){return g(e.ma,2)},"%e":function(e){return k(e.ma,2," ")},"%g":function(e){return p(e).toString().substring(2)},"%G":function(e){return p(e)},"%H":function(e){return g(e.ja,2)},"%I":function(e){e=e.ja;0==e?e=12:12<e&&(e-=12);return g(e,2)},"%j":function(e){for(var r=0,u=0;u<=e.ka-1;r+=(Kb(e.ga+1900)?Lb:Mb)[u++]);return g(e.ma+r,3)},"%m":function(e){return g(e.ka+1,2)},"%M":function(e){return g(e.Ea,2)},"%n":function(){return"\n"},"%p":function(e){return 0<=
e.ja&&12>e.ja?"AM":"PM"},"%S":function(e){return g(e.Fa,2)},"%t":function(){return"\t"},"%u":function(e){return e.da||7},"%U":function(e){return g(Math.floor((e.fa+7-e.da)/7),2)},"%V":function(e){var r=Math.floor((e.fa+7-(e.da+6)%7)/7);2>=(e.da+371-e.fa-2)%7&&r++;if(r)53==r&&(u=(e.da+371-e.fa)%7,4==u||3==u&&Kb(e.ga)||(r=1));else{r=52;var u=(e.da+7-e.fa-1)%7;(4==u||5==u&&Kb(e.ga%400-1))&&r++}return g(r,2)},"%w":function(e){return e.da},"%W":function(e){return g(Math.floor((e.fa+7-(e.da+6)%7)/7),2)},
"%y":function(e){return(e.ga+1900).toString().substring(2)},"%Y":function(e){return e.ga+1900},"%z":function(e){e=e.Da;var r=0<=e;e=Math.abs(e)/60;return(r?"+":"-")+String("0000"+(e/60*100+e%60)).slice(-4)},"%Z":function(e){return e.Ga},"%%":function(){return"%"}};d=d.replace(/%%/g,"\x00\x00");for(y in x)d.includes(y)&&(d=d.replace(new RegExp(y,"g"),x[y](f)));d=d.replace(/\0\0/g,"%");y=Nb(d);if(y.length>b)return 0;Aa.set(y,a);return y.length-1}function Pb(a){try{a()}catch(b){C(b)}}
...
function $b(a){if(!E){if(0===Z){var b=!1,d=!1;a(f=>{if(!E&&(Tb=f||0,b=!0,d)){Z=2;Pb(()=>ac(X));"undefined"!=typeof Browser&&Browser.la.va&&Browser.la.resume();f=!1;try{var k=(0,c.asm[Vb[P[X+8>>2]]])()}catch(q){k=q,f=!0}var g=!1;if(!X){var h=Xb;h&&(Xb=null,(f?h.reject:h.resolve)(k),g=!0)}if(f&&!g)throw k;}});d=!0;b||(Z=1,X=Zb(),"undefined"!=typeof Browser&&Browser.la.va&&Browser.la.pause(),Pb(()=>bc(X)))}else 2===Z?(Z=0,Pb(cc),vb(X),X=null,Yb.forEach(f=>wb(f))):C("invalid state: "+Z);return Tb}}
function dc(a){return $b(b=>{a().then(b)})}m.xa();z||(rb(a=>{sb=a;La()},()=>{sb=!1;La()}),"undefined"!=typeof ENVIRONMENT_IS_FETCH_WORKER&&ENVIRONMENT_IS_FETCH_WORKER||Ka());
var ec=[null,Sa,Ua,db,fb,gb,hb,kb,Db,Eb,Fb,Gb,Hb,Jb],gc={F:function(a){fc(a,!n,1,!ma);m.qa()},g:function(a){z?postMessage({cmd:"cleanupThread",thread:a}):Qa(a)},y:eb,f:fb,u:gb,v:hb,z:function(){return 65536},j:function(a){var b=V[a];b&&(delete V[a],0<b.readyState&&4>b.readyState&&b.abort())},A:function(){return!0},B:function(a,b,d,f){if(a==b)setTimeout(()=>Ya(f));else if(z)postMessage({targetThread:a,cmd:"processProxyingQueue",queue:f});else{a=m.ea[a];if(!a)return;a.postMessage({cmd:"processProxyingQueue",
...
(function(){function a(g,h){g=g.exports;g=Qb(g);c.asm=g;m.ra.push(c.asm.K);Ea.unshift(c.asm.H);wa=h;m.za(()=>La())}function b(g){a(g.instance,g.module)}function d(g){return Oa().then(function(h){return WebAssembly.instantiate(h,f)}).then(function(h){return h}).then(g,function(h){B("failed to asynchronously prepare wasm: "+h);C(h)})}var f={a:gc};Ka();if(c.instantiateWasm)try{var k=c.instantiateWasm(f,a);return k=Qb(k)}catch(g){B("Module.instantiateWasm callback failed with error: "+g),ca(g)}(function(){return va||
